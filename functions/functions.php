...
$con = mysqli_connect("localhost:3306","root","","ecommerce2");
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
			...
			echo "
				<div id='single_product'>
					...
					<h3>$pro_title</h3>
					<img src='admin/product_images/$pro_image' width='170' height='170' />
...
if (isset($_GET['cat'])){
	...
	if($count_cats==0){
		echo "<h2>There is no product in this category!";
	}
