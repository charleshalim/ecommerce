...
<form action="" method="post"  enctype="multipart/form-data">
	...
	<table align="center " width="972" border="2" bgcolor="orange">
			...
			<tr align="center">
				<td colspan="8"><h2><b>Ubah Produk</b></h2></td>
			</tr>

			<tr>
				<td align="right" ><b>Product Title:</b></td>
				<td><input type="text" name="product_title" size="100" value="<?php echo $pro_title;?>" /></td>
			</tr>
...
$update_product ="update products set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title',product_image='$product_image',product_keyword='$product_keywords',product_price='$product_price',product_desc='$product_desc' where product_id='$update_id'  ";
    ...
    echo "<script>window.open('adminpage.php?view_product','_self')</script>";
